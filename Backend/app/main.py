...
from app.api import authentification, users,statistics
...
app.include_router(statistics.router, prefix="/statistics", tags=["statistics"], dependencies=[Depends(oauth2_scheme)])
...
@app.get("/")
async def root():
    return {"message": "Welcome to Big Data app API!"}
